module github.com/chaseisabelle/phprom
...
require (
	...
	github.com/chaseisabelle/goresp v0.0.0-20200717104745-ed1fa67484d7
	github.com/chaseisabelle/resptcp v0.0.0-20200724152958-c7b3179102cb
